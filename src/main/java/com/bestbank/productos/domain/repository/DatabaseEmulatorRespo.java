...
public class DatabaseEmulatorRespo {
  ...
  private void initializeData() {
      ...
      /** Clase Prodructos **/
      ctaaData.put("minSaldoMensual", 0);
      ...
      /** Clase Prodructos **/
      ctccData.put("minSaldoMensual", 0);
      ...
      /** Clase Prodructos **/
      dpfjData.put("minSaldoMensual", 0);
      ...
      /** Clase Prodructos **/
      crpsData.put("minSaldoMensual", 0);
      ...
      /** Clase Prodructos **/
      crenData.put("minSaldoMensual", 0);
      ...
      /** Clase Prodructos **/
      crtcData.put("minSaldoMensual", 0);
      ...
      ctvipData.put("maxOperacionesMes", Integer.MAX_VALUE);
      ...
      /** Clase Prodructos **/
      ctvipData.put("minSaldoMensual", 500);
      ...
      ctepymeData.put("maxOperacionesMes", Integer.MAX_VALUE);
      ...
      /** Clase Prodructos **/
      ctepymeData.put("minSaldoMensual", 0);
